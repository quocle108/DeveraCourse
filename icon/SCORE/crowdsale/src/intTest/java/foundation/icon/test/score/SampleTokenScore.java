...
public class SampleTokenScore extends Score {
    ...
    public static SampleTokenScore mustDeploy(TransactionHandler txHandler, Wallet wallet,
        ...
        System.out.println("------ decimal: " + decimals.toString());
        System.out.println("------ initialSupply: " + initialSupply.toString());
    ...
    public void ensureTokenBalance(Address owner, BigInteger value) throws ResultTimeoutException, IOException {
        ...
        while (true) {
            ...
            } else if (balance.equals(value.multiply(BigInteger.TEN.pow(18)))) {
                LOG.info(msg);
                break;
            } else {
